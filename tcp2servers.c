/* tcp2servers v1.0 by  james@ustc.edu.cn 2016.05.11
   ./tcp2servers xxxx a.a.a.a:port b.b.b.b:port c.c.c.c:port
...
void usage()
{
	printf("tcp2servers v1.0 by james@ustc.edu.cn\n");
	printf("%s",
   	"./tcp2servers xxxx a.a.a.a:port [ b.b.b.b:port c.c.c.c:port ... ] \n"
   	"accept connection on tcp port xxxx\n"
...
#ifndef DEBUG
	daemon_init("tcp2servers",LOG_DAEMON);
#endif
